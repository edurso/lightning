...
public class DrivetrainCharacterization extends CommandBase {
    ...
    /**
     * Adds a DrivetrainCharacterization command to the Autonomous Chooser on Shuffleboard.
     * @param drivetrain The {@link com.lightningrobotics.common.subsystems.LightningDrivetrain LightningDrivetrain} to be characterized.
     */
    public static void load(LightningDrivetrain drivetrain) {
