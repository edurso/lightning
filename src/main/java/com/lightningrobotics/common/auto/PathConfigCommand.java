...
import com.lightningrobotics.common.util.JoystickFilter;
...
public class PathConfigCommand extends CommandBase {
    ...
    private final double MIN_PWR;

    private final double MAX_PWR;
	...
	public PathConfigCommand(LightningDrivetrain drivetrain, DoubleSupplier leftThrottle, DoubleSupplier rightThrottle, double deadband, double minPwr, double maxPwr) {
