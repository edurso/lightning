...
import com.lightningrobotics.common.commands.DashboardWaitCommand;
...
public class Autonomous {
    ...
    /**
     * Flag indicates if a {@link com.lightningrobotics.common.commands.DashboardWaitCommand} will be used in a 
    ...
    /**
     * Add command to list of autonomous commands. Will group with a {@link com.lightningrobotics.common.commands.DashboardWaitCommand}
    ...
    /**
     * Configures if {@link Autonomous#register(String, Command)} will group command with a {@link com.lightningrobotics.common.commands.DashboardWaitCommand}
     * if enabled ({@link Autonomous#setHasDashboardWaitCommand(boolean)}).
    ...
    /**
     * Configures if {@link Autonomous#register(String, Command)} will group command with a {@link com.lightningrobotics.common.commands.DashboardWaitCommand}.
     * @param hasWait {@code true} if there needs to be a {@link com.lightningrobotics.common.commands.DashboardWaitCommand}, false otherwise.
     */
